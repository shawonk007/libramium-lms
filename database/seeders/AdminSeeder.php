...
class AdminSeeder extends Seeder {
    ...
    public function run(): void {
        ...
        $admins = [
            ...
            [ 'firstname' => 'Muntana', 'lastname' => 'Annie', 'username' => 'muntaha.annie', 'email' => 'muntaha@gmail.com', 'email_verified_at' => date('Y-m-d H:i:s'), 'phone' => '+88 (012) 34-567891', 'password' => Hash::make('admin') ],
        ];
