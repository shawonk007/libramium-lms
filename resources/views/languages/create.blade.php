      ...
      <div class="card col-10 col-lg-6">
        <form action="{{ route('languages.store') }}" method="post">
          ...
          <div class="card-header">
            <h5 class="card-title mb-0">{{ __('Create New Language') }}</h5>
          </div>
          <div class="card-body py-0">
            <div class="row g-3">
              <div class="col-12">
                <input type="text" name="title" class="form-control" id="title" placeholder="{{ __('Language Title') }}" value="{{ old('title') }}" required />
              </div>
              <div class="col-12">
              ...
              <div class="col-6">
                <input type="text" name="slug" class="form-control" id="slug" placeholder="{{ __('Language Slug') }}" value="{{ old('slug') }}" readonly />
              </div>
              <div class="col-6">
