      ...
      <div class="card col-10 col-lg-6">
        <form action="{{ route('genres.store') }}" method="post">
          ...
          <div class="card-body py-0">
            <div class="row g-3">
              <div class="col-12">
                <input type="text" name="title" class="form-control" id="title" placeholder="{{ __('Genre Title') }}" value="{{ old('title') }}" required />
              </div>
              <div class="col-12">
              ...
              <div class="col-6">
                <input type="text" name="slug" class="form-control" id="slug" placeholder="{{ __('Genre Slug') }}" value="{{ old('slug') }}" readonly />
              </div>
              <div class="col-6">
