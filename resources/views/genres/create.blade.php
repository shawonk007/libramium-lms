      ...
      <div class="card col-10 col-lg-6">
        <form action="{{ route('genres.store') }}" method="post">
          ...
          <div class="card-header">
            <h5 class="card-title mb-0">{{ __('Create New Genre') }}</h5>
          </div>
          <div class="card-body py-0">
            <div class="row g-3">
              <div class="col-12">
                ...
                <input type="text" name="title" class="form-control mt-2" id="title" placeholder="{{ __('Fiction') }}" value="{{ old('title') }}" required />
              </div>
              <div class="col-12">
              ...
              <div class="col-6">
                ...
                <input type="text" name="slug" class="form-control mt-2" id="slug" placeholder="{{ __('fiction') }}" value="{{ old('slug') }}" readonly />
              </div>
              <div class="col-6">
                <label for="status">
